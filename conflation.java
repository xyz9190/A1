...
try {
File fi = new 
File("/home/siddhi/Documents/input.txt");
...
new 
FileWriter("without_punctuation_and_stopwords.txt"));
...
!str_r.toLowerCase().equals("is")
&& !str_r.toLowerCase().equals("and") && 
!str_r.toLowerCase().equals("of")
&& !str_r.toLowerCase().equals("are") && 
!str_r.toLowerCase().equals("for")
